...
\begin{titlepage}
	...
	\begin{center}
		...
		\textbf{Análisis y clasificación de los componentes alimenticios para la prevención del metabolismo de la glucosa en los estudiantes universitarios aplicando IA}
		\vspace*{8ex}\\	
